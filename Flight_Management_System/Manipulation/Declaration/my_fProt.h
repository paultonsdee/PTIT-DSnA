...
void add_flight_popup(FlightListPTR &, PlaneList &, bool &);
...
void link_list_initialize(FlightListPTR &);
void insert_flight(FlightListPTR &, const char *&, char (&)[5], const char *&, PlaneList &, int &, int &, int &, int &, int &, int &);
FlightListPTR new_flight (void);
int count_flights (FlightListPTR );