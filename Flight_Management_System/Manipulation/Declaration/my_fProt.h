...
void add_flight_popup(FlightNodePTR &, PlaneList &, bool &, int &, int &);
...
bool is_alpha (char &);
bool is_six_hour_dif_day(int &, int &, int &, int &);
...
bool insert_flight(FlightNodePTR &, const char *&, char (&)[5], const char *&, PlaneList &, int &, int &, int &, int &, int &, int &);
